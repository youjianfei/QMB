...
public class Adapter_Coupon extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (viewHolder == null) {
            ...
            viewHolder.linearlayout_left = convertView.findViewById(R.id.linearlayout_left);
        ...
        if (type.equals("优惠券")) {
            ...
            if (mData.get(position).getUsable() == 0)//优惠券是否不可用
            {
                viewHolder.linearlayout_left.setBackgroundResource(R.mipmap.coupon_gray);
            } else {
                viewHolder.linearlayout_left.setBackgroundResource(R.mipmap.coupon);
            }
        }
